...
#co-ordinates for the Leo celestial found in stellar-database
x1 = [-67,-34.97,-59,-53,-86,-61.4,-83.4,-13.5,-57,-72.2]
y1 = [35.5,1.671,27.6,10.7,9.66,29.5,48.1,6.53,8.32,8.95]
z1 = [16.1,9.102,23,20.2,4.62,29.1,44,5.5,3.03,18.6]
...
#scatter plot x,y and z
ax1.scatter(x1,y1)
ax2.scatter(x1,z1)
ax3.scatter(y1,z1)

#add titles 
ax1.title.set_text('X and Y')
ax2.title.set_text('X and Z')
ax3.title.set_text('Y and Z')
...
#add subplot 3D
ax4 = fig_3d.add_subplot(1,1,1, projection="3d")

#create a 3d scatter plot
constellation3d_2 = ax4.scatter(x1,y1,z1)
